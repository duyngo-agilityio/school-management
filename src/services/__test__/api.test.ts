...
describe("api service test", () => {
  ...
  it("apiClient.put will return value incorrectly", async () => {
    global.fetch = jest.fn(() =>
      Promise.resolve({
        ok: false,
  ...
  it("apiClient.get will return value incorrectly", async () => {
    global.fetch = jest.fn(() =>
      Promise.resolve({
        ok: false,
        json: () => Promise.resolve(undefined),
  ...
  it("apiClient.post will return value incorrectly", async () => {
    global.fetch = jest.fn(() =>
      Promise.resolve({
        ok: false,
        json: () => Promise.resolve(undefined),
  ...
  it("apiClient.delete will return value incorrectly", async () => {
    global.fetch = jest.fn(() =>
      Promise.resolve({
        ok: false,
        json: () => Promise.resolve(undefined),
